...
ActiveRecord::Schema.define(version: 2021_05_12_120247) do
  ...
  create_table "esdl_suite_ids", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
